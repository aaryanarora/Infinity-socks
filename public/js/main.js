...
(function ($) {
    ...
    const alink = document.querySelectorAll(".wan");
    const imglink = document.querySelectorAll(".ppic");
    function whatsapp(){
        for (i = 0; i < alink.length; i++) {
            var x = imglink[i].getAttribute("src");
            alink[i].setAttribute("href","http://wa.me/919953039807?text=https://aaryanarora.github.io/Infinity-socks/public/" + x);
    ...
    const productName = document.querySelectorAll(".js-name-b2 h2");
    const sbtn = document.querySelector("zmdi zmdi-search");
    ...
    function filterProducts(e) {
        ...
        productName.forEach(function(product) {
            ...
            if (item.toLowerCase().indexOf(text) != -1) {
                ...
                product.parentElement.parentElement.parentElement.parentElement.parentElement.style.right = 0;
